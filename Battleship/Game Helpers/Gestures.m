...
- (instancetype) initGesturesWithNode:(SKNode*) gesturesNode
    ...
    if (self) {
        ...
        _helper = helper;
        _initialMaxX = _sizes.fullScreenWidth - _sizes.visualBarWidth;
        _initialMaxY = _sizes.fullScreenHeight;
    }
    return self;
}
...
-(void) handlePinchWithRecognizerScale:(CGFloat) scale  {
    ...
    _newMaxX = (_sizes.fullScreenWidth - _sizes.visualBarWidth) * _gesturesNode.xScale;
    _newMaxY = (_sizes.fullScreenHeight) * _gesturesNode.yScale;
